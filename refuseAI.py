...
表現面（言葉遣い、態度、丁寧さなど）：以下の内容が含まれているかで判断（５点満点）
・相手との関係性に応じた適切さ:１点
    ・相手が目上の人の場合、直接的な断り表現になっていないか、適切な敬語が使用されているか。
    ・相手が親しい関係の場合、フランクで自然な表現か。
・謝罪の言葉の有無と適切さ：1点
・全体的な丁寧さ、配慮が感じられるか：１点
・文法的な正確さ、自然な言い回しか：２点

内容面（断りの理由、代替案など）：表現面と同様に判断
・断りの意思の明確さ: 曖昧さがないか、はっきりと伝わるか：１点
・理由の提示の有無と適切さ: 納得できる理由か、具体性があるか：１点
・代替案の提示の有無と適切さ: 別の機会や方法を提案しているか：１点
・相手への配慮: 相手の誘い自体を否定せず、感謝の言葉があるか：１点
・内容の一貫性: 矛盾した内容になっていないか：１点
